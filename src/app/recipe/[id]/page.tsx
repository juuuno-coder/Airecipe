                    ...
                    {(recipe.before_image_url && recipe.after_image_url) ? (
                        <div className="mt-8">
                            ...
                            <ImageComparison 
                                ...
                                className="w-full aspect-[2/3] shadow-2xl border border-indigo-500/20 rounded-2xl overflow-hidden"
                            />
                        </div>
                    ) : recipe.image_url && (
                        <div className="mt-8 rounded-2xl overflow-hidden border border-white/5 shadow-2xl aspect-[2/3] relative group">
